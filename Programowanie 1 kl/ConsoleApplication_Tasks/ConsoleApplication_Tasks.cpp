...
//    {
//        roll_result = roll_result + rand() % (diceNumber - 1 + 1) + 1;
//    }
...
void changeCoordinate(point& coordinate, keyCode currentKeyCode)
{
    ...
    //case keyCode::ENTER:
    //    if (pointOne != 0)
    //        pointOne = currentCoordinates;
    //    else
    //        pointTwo = currenCoordinates;
    }
...
void task6()
{
    ...
    {
        getKeyCode();
        changeCoordinate(currentCoordinates, currentKeyCode);
        Sleep(300);
    }
}
